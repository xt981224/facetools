 ...
 * @LastEditTime: 2020-06-21 22:19:28
--> 
<template >
								...
								<el-form ref="createVehicleForm" :model="createVehicleForm"  label-width="100px">
									<el-row>
										<el-col :span="4" :xs="24" style="padding: 20px" class="imgflagxs" >
											<img style="width:100%;text-align:right" src="https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg"/>
										</el-col>
									...
									<el-row>
										...
										<el-col :span="4" :xs="24" style="padding: 20px" class="imgflagclass" >
											<img style="width:150px;text-align:right" src="https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg"/>
										</el-col>
									</el-row>
									...
									<el-row class="addtoosxs">
										<el-col :span="9" :xs="24" >
											<el-form-item label="工器具名称">
												<el-input v-model="tools.toolName" style="width:153px"></el-input>
											</el-form-item>
										</el-col>
										<el-col :span="4" :xs="24" style="margin-left:20px;margin-top:20px;text-align: center;" >
											<el-upload  type="drag" ref="upload" :headers="{Accept:'application/json, text/plain, */*'}" action="#" :http-request="upload1" :on-success="uploadSuccesssfz1"
												:on-remove="handleRemove" style="width:300px;" list-type="picture" :file-list="fileList">
												<div>
												<el-button  type="success" width="100%">点击上传</el-button>
												<el-button type="primary" @click.stop="addtoolone">保存</el-button>
												</div>
										...
										<el-row style="margin-top:30px;text-align:center" class="addtoosxs" >
											<el-button style="width:80%;" type="primary" @click="submitForm('createVehicleForm')">提交</el-button>
										</el-row>
